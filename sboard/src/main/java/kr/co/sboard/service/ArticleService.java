...
public class ArticleService {
    ...
    public ArticleDTO selectArticleAndHitPlus(int no){
        Tuple articleTuple  = articleRepository.selectArticleAndHitPlus(no);

        Article article = articleTuple.get(0, Article.class);
        String nick = articleTuple.get(1, String.class);
    ...
    public ArticleDTO insertComment(ArticleDTO articleDTO){
        ...
        log.info("parentArticle : " + parentArticle.toString());
    ...
    public List<ArticleDTO> selectComment(int no){
        List<Tuple> articles = articleRepository.selectComment(no);
