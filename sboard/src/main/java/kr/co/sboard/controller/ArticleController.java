...
public class ArticleController {
    ...
    public String write(HttpServletRequest req, ArticleDTO articleDTO, PageRequestDTO pageRequestDTO){
        log.info("/article/write - POST");
        log.info("write articleDTO : " + articleDTO.toString());
        log.info("write pageRequestDTO : " + pageRequestDTO.toString());
        ...
        return "redirect:/article/view?no=" + no + "&cate=" + pageRequestDTO.getCate() + "&pg=" + pageRequestDTO.getPg();
    }

    // 게시글 수정 페이지 매핑
    @GetMapping("/article/modify")
    public String modify(int no, Model model, PageRequestDTO pageRequestDTO){
    ...
    public String modify(HttpServletRequest req, ArticleDTO articleDTO, PageRequestDTO pageRequestDTO){
    ...
    public ResponseEntity<?> comment(HttpServletRequest req, @RequestBody ArticleDTO articleDTO){
        ...
        ArticleDTO insertArticle = articleService.insertComment(articleDTO);
        String userProfile = articleService.selectProfile(articleDTO.getWriter());

        insertArticle.setProfile(userProfile);

        Map<String, ArticleDTO> result = new HashMap<>();
        result.put("result", insertArticle);

        log.info("insertArticle : " + insertArticle);
